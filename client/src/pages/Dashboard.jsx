...
import api from '../api';
import { FiUsers, FiClipboard, FiAlertCircle, FiMapPin, FiUserX } from 'react-icons/fi';

export default function Dashboard() {
  const { user } = useAuth();
  const [stats, setStats] = useState({ customers: 0, trials: 0, complaints: 0, movements: 0, lostCustomers: 0 });
