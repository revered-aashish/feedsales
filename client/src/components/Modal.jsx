...
export default function Modal({ title, onClose, children }) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center sm:p-4"
      style={{ zIndex: 9999, paddingBottom: 'env(safe-area-inset-bottom)' }}
      onClick={onClose}
    >
      <div
        className="bg-white rounded-t-2xl sm:rounded-xl shadow-xl w-full sm:max-w-lg max-h-[85dvh] sm:max-h-[90vh] overflow-y-auto"
